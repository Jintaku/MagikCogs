...
class Mycog:
    ...
    async def about(self):
        ...
        embed.add_field(name="Discord Support", value="<a href="https://discord.gg/kQjTw5Z">Visit our Discord Server</a>", inline=True)
        embed.add_field(name="Website", value="<a href="http://www.magikbot.co.uk">Visit our Website</a>", inline=True)
