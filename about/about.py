...
class About:
    ...
    async def about(self):
        ...
        embed.set_author(name="Magik bot", url='http://www.magikbot.co.uk', icon_url='https://cdn.discordapp.com/avatars/375541314139324416/d416c13ce8d6601f7c7db39242799aff.png?size=1024')
        embed.set_thumbnail(url='https://cdn.discordapp.com/avatars/375541314139324416/d416c13ce8d6601f7c7db39242799aff.png?size=1024')
        embed.add_field(name="Discord Support", value="https://discord.gg/d7YGVbH", inline=True)
